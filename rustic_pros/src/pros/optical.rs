...
pub type optical_direction_e = ::core::ffi::c_uint;
...
fn bindgen_test_layout_optical_rgb_s() {
    const UNINIT: ::core::mem::MaybeUninit<optical_rgb_s> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<optical_rgb_s>(),
        32usize,
        concat!("Size of: ", stringify!(optical_rgb_s))
    );
    assert_eq!(
        ::core::mem::align_of::<optical_rgb_s>(),
        8usize,
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).brightness) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(optical_rgb_s),
...
fn bindgen_test_layout_optical_raw_s() {
    const UNINIT: ::core::mem::MaybeUninit<optical_raw_s> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<optical_raw_s>(),
        16usize,
        concat!("Size of: ", stringify!(optical_raw_s))
    );
    assert_eq!(
        ::core::mem::align_of::<optical_raw_s>(),
        4usize,
...
fn bindgen_test_layout_optical_gesture_s() {
    const UNINIT: ::core::mem::MaybeUninit<optical_gesture_s> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<optical_gesture_s>(),
        12usize,
        concat!("Size of: ", stringify!(optical_gesture_s))
    );
    assert_eq!(
        ::core::mem::align_of::<optical_gesture_s>(),
        4usize,
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ddata) as usize - ptr as usize },
        1usize,
        concat!(
            "Offset of field: ",
            stringify!(optical_gesture_s),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).ldata) as usize - ptr as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(optical_gesture_s),
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).rdata) as usize - ptr as usize },
        3usize,
        concat!(
            "Offset of field: ",
            stringify!(optical_gesture_s),
